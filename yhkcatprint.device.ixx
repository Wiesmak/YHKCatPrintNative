...
export module yhkcatprint:device;

import std;
import :rfcomm;

/**
 * @file yhkcatprint.device.ixx
 * @brief Defines an abstract interface representing a remote Bluetooth device.
 *
 * This module provides an interface for interacting with Bluetooth devices,
...
export namespace yhkcatprint
{
	...
	public:
		 ...
		 */
		virtual std::shared_ptr<IRfcommSocket> createRfcommSocket(std::uint8_t channel, ConnectOptions options) = 0;
	};
}